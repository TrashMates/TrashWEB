...
$(document).ready(function () {
    ...
    stats.discord = {};
    stats.twitch = {};
    $.when($.get("https://api.laravel.local/stats/twitch/events", function (events) {
        stats.twitch.events = events;
    }), $.get("https://api.laravel.local/stats/twitch/messages", function (messages) {
        stats.twitch.messages = messages;
    }), $.get("https://api.laravel.local/stats/twitch/viewers", function (viewers) {
        stats.twitch.viewers = viewers;
    }), $.get("https://api.laravel.local/stats/discord/events", function (events) {
        stats.discord.events = events;
    }), $.get("https://api.laravel.local/stats/discord/messages", function (messages) {
        stats.discord.messages = messages;
    }), $.get("https://api.laravel.local/stats/discord/viewers", function (viewers) {
